...
function VideoMain() {
  ...
  return (
    <div className="py-6 px-8 mo:py-0 mo:px-0">
      <h1 className="sr-only">유튜브 목록 페이지</h1>

      <section className="mo:w-3/4 mo:mx-auto tb:grid tb:grid-flow-row  tb:grid-cols-2 pc:grid pc:grid-cols-3 lgpc:grid lgpc:grid-cols-4 gap-4 min-w-[360px]">
        {data?.items.map((item) => (
          <VideoComponets
            detail="both"
            page="main"
