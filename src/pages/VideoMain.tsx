...
function VideoMain() {
  ...
  return (
    <div className="py-6 px-8">
      ...
      <section className="bg-blue-100 flex flex-col mx-auto tb:grid tb:grid-flow-row  tb:grid-cols-2 pc:grid pc:grid-cols-3 lgpc:grid lgpc:grid-cols-4 gap-4 min-w-[360px]">
        {data?.items.map((item) => (
          <VideoComponets
            detail="both"
            page="main"
